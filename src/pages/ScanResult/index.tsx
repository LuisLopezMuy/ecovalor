...
export default function ScanResult() {
  ...
  const { material, suggestedCenters } = useMemo(() => {
    const randomMaterial =
      materialsData[Math.floor(Math.random() * materialsData.length)];
  ...
  const DynamicIcon =
    (LucideIcons as any)[material.icon] || LucideIcons.HelpCircle;
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ...
          <div>
            ...
            >
              <CheckCircle2 size={16} /> Alta Probabilidad (
              {material.confidence}%)
            </div>
            <h2
              style={{
        ...
        >
          ...
          <div
            style={{ fontSize: "1.2rem", fontWeight: "900", color: "#DDEE8A" }}
          >
            Q{material.basePriceMin} - Q{material.basePriceMax}{" "}
            <span style={{ fontSize: "0.8rem", fontWeight: "500" }}>/ lb</span>
          </div>
        </div>
      </div>
      ...
      >
        Según tu escaneo, estos centros locales compran este material a
        excelentes precios:
      </p>
